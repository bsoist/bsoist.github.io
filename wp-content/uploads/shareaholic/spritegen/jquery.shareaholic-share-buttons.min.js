...
c.attr("shr_form_factor");c.addClass(e+"-head");c.attr("data-shr_link")||c.attr("shr_link");c.attr("data-shr_title")||c.attr("shr_title");c.attr("data-shr_short_link")||c.attr("shr_short_link");c.children("#shareaholic-services").wrapInner("<ul></ul>");b(e,c)})};var b=function(b,e){SHR4P.debug("SHR4P.TB.layoutFormFactor called");if(!(typeof b=="undefined"||!b||typeof e=="undefined"||!e)&&b=="shareaholic-top-bar"&&!d){var d=!0,f=SHRTB_Settings.topBarBgColor,h=SHRTB_Settings.topBarBorderColor,d=!1,
...
a("<div id='shareToolBarContainer'></div>"),h=a("<div id='shareToolBarFooter'></div>"),d=a("<div id='shareaholic-bar' class='shareToolBarShadow' style='display:none'></div>"),l=a("<div id='shareToolBar'></div>");e.wrap(l);l=e.parents("#shareToolBar");l.wrap(g);g=l.parents("#shareToolBarContainer");g.wrap(d);d=g.parents("#shareaholic-bar");f.prependTo(d);h.appendTo(d);f=e.parents("#shareaholic-bar");SHR4P.debug(f);a('<div id="showHideToolBar" title="Click to hide"><div class="shareToolBarButton shareToolBarHideButton"></div></div>').appendTo(g);
